...
#define kRegisterInfoDidChangeNotification @"registerInfoDidChange"
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(registerInfoDidChange:) name:kRegisterInfoDidChangeNotification object:nil];
}
...
- (void)registerInfoDidChange:(NSNotification *)notify {
    
    NSDictionary *info = notify.userInfo;
    
    self.userTextField.text = info[@"emall"];
